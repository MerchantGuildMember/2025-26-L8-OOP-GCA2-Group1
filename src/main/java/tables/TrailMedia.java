...
public class TrailMedia {
    ...
    public Long getStop_id() {return stop_id;}
    ...
    public void setTrail_id(Long trail_id) {this.trail_id = trail_id;}
    public void setStop_id(Long stop_id) {this.stop_id = stop_id;}
